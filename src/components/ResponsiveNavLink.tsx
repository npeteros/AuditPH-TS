...
export default function ResponsiveNavLink({ active = false, className = '', children, href, ...props }: { active: boolean, className: string, children: React.ReactNode, href: string }) {
    return (
        <Link
            href={href}
            {...props}
