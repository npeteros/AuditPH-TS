    ...
    return (
        <>
            <div className="max-w-5xl mx-auto p-4 sm:p-6 lg:p-6">
                <div
                    className="w-full bg-white border-gray-300 focus:border-indigo-300 rounded-3xl shadow-sm my-6">
                    <DivLink
                    ...
                    >
                        <div className="p-2 flex">
                            ...
                            <div className="flex flex-col justify-center w-2/3">
                                ...
                                <div className="text-m">See the complete history of your transactions on a budget</div>
                            </div>
                        </div>
                    </DivLink>
                </div>
                ...
                <div className="w-full bg-white border-gray-300 focus:border-indigo-300 rounded-3xl shadow-sm my-6">
                    <div className="p-2 flex">
                        ...
                        <div className="flex flex-col justify-center w-2/3">
                            ...
                            <div className="text-m">See where you are earning or spending the most</div>
                        </div>
                    </div>
                </div>
