                ...
                <div className="fixed top-0 right-0 p-6 w-fit text-right mt-1">
                    {
                        session?.user ? (
                            <Link
                                href="/dashboard"
                            >
                                <span className="font-medium text-neutral-800 hover:text-neutral-400 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-neutral-500">Dashboard</span>
                            </Link>
                        ) : (
                            <>
                                <Link
                                    href="/login"
                                    className="font-medium text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-neutral-500"
                                >
                                    Log in
                                </Link>
                                ...
                                <Link
                                    href="/register"
                                    className="ml-4 font-medium text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-neutral-500"
                                >
                                    Register
                                </Link>
                            </>
